			...
			<section class="banner-con">
				<div class="wrapper">
					<div class="banner-div">
						...
						echo "
							<ul>
								<li><a class='active' href='funeral_tradition.php?id={$provider['provider_id']}' >Traditional</a></li>
								<li><a class='' href='funeral_cremate.php?id={$provider['provider_id']}'>Cremation</a></li>
							</ul>
						";
						?>
