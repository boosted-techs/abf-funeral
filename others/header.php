<div class="header">
	...
	<picture>
		...
		<?php
				...
				else echo "<img class='header-logo' src='images/providers/".$provider['provider_type']."/".$_SESSION['provider']."/".$provider['provider_logo']."' >";
			}
			else echo "<img class='header-logo' src='images/main-logo.png'>";
		?>
